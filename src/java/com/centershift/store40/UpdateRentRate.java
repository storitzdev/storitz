 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}UpdateRentRate_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UpdateRentRate")
public class UpdateRentRate {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected UpdateRentRateRequest request;
     ...
     *
     * @return possible object is
     *         {@link UpdateRentRateRequest }
     */
    public UpdateRentRateRequest getRequest() {
        return request;
    }
     ...
     *              {@link UpdateRentRateRequest }
     */
    public void setRequest(UpdateRentRateRequest value) {
        this.request = value;
    }
