 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetMoveOutInfo_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetMoveOutInfo")
public class GetMoveOutInfo {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetMoveOutInfoRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetMoveOutInfoRequest }
     *     
     */
    public GetMoveOutInfoRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetMoveOutInfoRequest value) {
        this.request = value;
    }
