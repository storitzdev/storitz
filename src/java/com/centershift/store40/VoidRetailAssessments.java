 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}VoidRetailAssessment_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "VoidRetailAssessments")
public class VoidRetailAssessments {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected VoidRetailAssessmentRequest request;
     ...
     *
     * @return possible object is
     *         {@link VoidRetailAssessmentRequest }
     */
    public VoidRetailAssessmentRequest getRequest() {
        return request;
    }
     ...
     *              {@link VoidRetailAssessmentRequest }
     */
    public void setRequest(VoidRetailAssessmentRequest value) {
        this.request = value;
    }
