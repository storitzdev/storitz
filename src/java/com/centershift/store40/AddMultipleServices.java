 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}AddMultipleService_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "AddMultipleServices")
public class AddMultipleServices {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected AddMultipleServiceRequest request;
     ...
     *     
     */
    public AddMultipleServiceRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(AddMultipleServiceRequest value) {
        this.request = value;
    }
