 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetDelinqSchedule_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetDelinqSchedule")
public class GetDelinqSchedule {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetDelinqScheduleRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetDelinqScheduleRequest }
     *     
     */
    public GetDelinqScheduleRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetDelinqScheduleRequest value) {
        this.request = value;
    }
