 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetPartialPayRules_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetPartialPayRules")
public class GetPartialPayRules {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetPartialPayRulesRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetPartialPayRulesRequest }
     *     
     */
    public GetPartialPayRulesRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetPartialPayRulesRequest value) {
        this.request = value;
    }
