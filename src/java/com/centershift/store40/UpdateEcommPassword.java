 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}UpdateEcommPassword_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UpdateEcommPassword")
public class UpdateEcommPassword {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected UpdateEcommPasswordRequest request;
     ...
     * @return
     *     possible object is
     *     {@link UpdateEcommPasswordRequest }
     *     
     */
    public UpdateEcommPasswordRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(UpdateEcommPasswordRequest value) {
        this.request = value;
    }
