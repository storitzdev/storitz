 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}AddDeposit_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "AddDeposit")
public class AddDeposit {
    ...
    protected AddDepositRequest request;
     ...
     * @return
     *     possible object is
     *     {@link AddDepositRequest }
     *     
     */
    public AddDepositRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(AddDepositRequest value) {
        this.request = value;
    }
