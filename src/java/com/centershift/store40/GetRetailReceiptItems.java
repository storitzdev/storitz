 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetRetailReceiptItems_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetRetailReceiptItems")
public class GetRetailReceiptItems {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetRetailReceiptItemsRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetRetailReceiptItemsRequest }
     */
    public GetRetailReceiptItemsRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetRetailReceiptItemsRequest }
     */
    public void setRequest(GetRetailReceiptItemsRequest value) {
        this.request = value;
    }
