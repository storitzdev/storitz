 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetRefundTypes_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetRefundTypes")
public class GetRefundTypes {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetRefundTypesRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetRefundTypesRequest }
     *     
     */
    public GetRefundTypesRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetRefundTypesRequest value) {
        this.request = value;
    }
