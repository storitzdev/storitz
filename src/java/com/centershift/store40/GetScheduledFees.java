 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetScheduledFees_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetScheduledFees")
public class GetScheduledFees {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetScheduledFeesRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetScheduledFeesRequest }
     *     
     */
    public GetScheduledFeesRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetScheduledFeesRequest value) {
        this.request = value;
    }
