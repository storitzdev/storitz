 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}VersResAssessBundle_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "VersResAssessBundle")
public class VersResAssessBundle {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected VersResAssessBundleRequest request;
     ...
     *
     * @return possible object is
     *         {@link VersResAssessBundleRequest }
     */
    public VersResAssessBundleRequest getRequest() {
        return request;
    }
     ...
     *              {@link VersResAssessBundleRequest }
     */
    public void setRequest(VersResAssessBundleRequest value) {
        this.request = value;
    }
