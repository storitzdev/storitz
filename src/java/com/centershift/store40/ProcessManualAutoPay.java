 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}ProcessManualAutoPay_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ProcessManualAutoPay")
public class ProcessManualAutoPay {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected ProcessManualAutoPayRequest request;
     ...
     *
     * @return possible object is
     *         {@link ProcessManualAutoPayRequest }
     */
    public ProcessManualAutoPayRequest getRequest() {
        return request;
    }
     ...
     *              {@link ProcessManualAutoPayRequest }
     */
    public void setRequest(ProcessManualAutoPayRequest value) {
        this.request = value;
    }
