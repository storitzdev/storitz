 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}CreateNewEcommAccount_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CreateNewEcommAccount")
public class CreateNewEcommAccount {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected CreateNewEcommAccountRequest request;
     ...
     *
     * @return possible object is
     *         {@link CreateNewEcommAccountRequest }
     */
    public CreateNewEcommAccountRequest getRequest() {
        return request;
    }
     ...
     *              {@link CreateNewEcommAccountRequest }
     */
    public void setRequest(CreateNewEcommAccountRequest value) {
        this.request = value;
    }
