 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetEstimatedRefund_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetEstimatedRefund")
public class GetEstimatedRefund {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetEstimatedRefundRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetEstimatedRefundRequest }
     *     
     */
    public GetEstimatedRefundRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetEstimatedRefundRequest value) {
        this.request = value;
    }
