 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}SendEmailWithUnit_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SendEmailWithUnit")
public class SendEmailWithUnit {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected SendEmailWithUnitRequest request;
     ...
     * @return
     *     possible object is
     *     {@link SendEmailWithUnitRequest }
     *     
     */
    public SendEmailWithUnitRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(SendEmailWithUnitRequest value) {
        this.request = value;
    }
