 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetAssessments_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetAssessments")
public class GetAssessments {
    ...
    protected GetAssessmentsRequest request;
     ...
     */
    public GetAssessmentsRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetAssessmentsRequest }
     */
    public void setRequest(GetAssessmentsRequest value) {
        this.request = value;
    }
