 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetQuoteData_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetQuoteData")
public class GetQuoteData {
    ...
    protected GetQuoteDataRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetQuoteDataRequest }
     *     
     */
    public GetQuoteDataRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetQuoteDataRequest value) {
        this.request = value;
    }
