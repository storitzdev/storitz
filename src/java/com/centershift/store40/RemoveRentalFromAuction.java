 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}RemoveRentalFromAuction_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "RemoveRentalFromAuction")
public class RemoveRentalFromAuction {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected RemoveRentalFromAuctionRequest request;
     ...
     * @return
     *     possible object is
     *     {@link RemoveRentalFromAuctionRequest }
     *     
     */
    public RemoveRentalFromAuctionRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(RemoveRentalFromAuctionRequest value) {
        this.request = value;
    }
