 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}WaiveFee_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class WaiveFee {
     ...
     * @return
     *     possible object is
     *     {@link WaiveFeeRequest }
     *     
     */
    public WaiveFeeRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(WaiveFeeRequest value) {
        this.request = value;
    }
