 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetSiteDetails_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetSiteDetails")
public class GetSiteDetails {
    ...
    protected GetSiteDetailsRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetSiteDetailsRequest }
     */
    public GetSiteDetailsRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetSiteDetailsRequest }
     */
    public void setRequest(GetSiteDetailsRequest value) {
        this.request = value;
    }
