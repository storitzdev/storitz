 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}SellRetailWithAccountMultiple_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SellRetailWithAccountMultiple")
public class SellRetailWithAccountMultiple {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected SellRetailWithAccountMultipleRequest request;
     ...
     *     
     */
    public SellRetailWithAccountMultipleRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(SellRetailWithAccountMultipleRequest value) {
        this.request = value;
    }
