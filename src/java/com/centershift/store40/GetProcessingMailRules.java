 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}getRules_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getProcessingMailRules")
public class GetProcessingMailRules {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetRulesRequest request;
     ...
     *     
     */
    public void setRequest(GetRulesRequest value) {
        this.request = value;
    }
