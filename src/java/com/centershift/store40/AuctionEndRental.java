 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}AuctionEndRental_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "AuctionEndRental")
public class AuctionEndRental {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected AuctionEndRentalRequest request;
     ...
     * @return
     *     possible object is
     *     {@link AuctionEndRentalRequest }
     *     
     */
    public AuctionEndRentalRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(AuctionEndRentalRequest value) {
        this.request = value;
    }
