 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}CreateAuctionEndRental_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CreateAuctionEndRental")
public class CreateAuctionEndRental {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected CreateAuctionEndRentalRequest request;
     ...
     *
     * @return possible object is
     *         {@link CreateAuctionEndRentalRequest }
     */
    public CreateAuctionEndRentalRequest getRequest() {
        return request;
    }
     ...
     *              {@link CreateAuctionEndRentalRequest }
     */
    public void setRequest(CreateAuctionEndRentalRequest value) {
        this.request = value;
    }
