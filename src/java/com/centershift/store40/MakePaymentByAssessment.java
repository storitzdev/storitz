 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}MakePaymentByAssessment_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "MakePaymentByAssessment")
public class MakePaymentByAssessment {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected MakePaymentByAssessmentRequest request;
     ...
     * @return
     *     possible object is
     *     {@link MakePaymentByAssessmentRequest }
     *     
     */
    public MakePaymentByAssessmentRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(MakePaymentByAssessmentRequest value) {
        this.request = value;
    }
