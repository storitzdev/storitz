 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetPrimaryRentalInfo_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetPrimaryRentalInfo")
public class GetPrimaryRentalInfo {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetPrimaryRentalInfoRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetPrimaryRentalInfoRequest }
     *     
     */
    public GetPrimaryRentalInfoRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetPrimaryRentalInfoRequest value) {
        this.request = value;
    }
