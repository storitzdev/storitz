 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}ApplyPCDs_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ApplyPCDs {
     ...
     * @return
     *     possible object is
     *     {@link ApplyPCDsRequest }
     *     
     */
    public ApplyPCDsRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(ApplyPCDsRequest value) {
        this.request = value;
    }
