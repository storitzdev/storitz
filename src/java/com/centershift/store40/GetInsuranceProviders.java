 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetInsuranceProviders_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetInsuranceProviders")
public class GetInsuranceProviders {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetInsuranceProvidersRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetInsuranceProvidersRequest }
     */
    public GetInsuranceProvidersRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetInsuranceProvidersRequest }
     */
    public void setRequest(GetInsuranceProvidersRequest value) {
        this.request = value;
    }
