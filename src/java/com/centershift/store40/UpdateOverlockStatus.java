 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}UpdateOverlockStatus_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UpdateOverlockStatus")
public class UpdateOverlockStatus {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected UpdateOverlockStatusRequest request;
     ...
     * @return
     *     possible object is
     *     {@link UpdateOverlockStatusRequest }
     *     
     */
    public UpdateOverlockStatusRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(UpdateOverlockStatusRequest value) {
        this.request = value;
    }
