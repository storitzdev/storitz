 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}UpdateLeasePeriod_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UpdateLeasePeriod")
public class UpdateLeasePeriod {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected UpdateLeasePeriodRequest request;
     ...
     *
     * @return possible object is
     *         {@link UpdateLeasePeriodRequest }
     */
    public UpdateLeasePeriodRequest getRequest() {
        return request;
    }
     ...
     *              {@link UpdateLeasePeriodRequest }
     */
    public void setRequest(UpdateLeasePeriodRequest value) {
        this.request = value;
    }
