 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}scheduledLetter_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "scheduledLetter")
public class ScheduledLetter {
    ...
    protected ScheduledLetterRequest request;
     ...
     * @return
     *     possible object is
     *     {@link ScheduledLetterRequest }
     *     
     */
    public ScheduledLetterRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(ScheduledLetterRequest value) {
        this.request = value;
    }
