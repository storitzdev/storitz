 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}VoidTransaction_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class VoidTransaction {
    ...
    protected VoidTransactionRequest request;
     ...
     * @return
     *     possible object is
     *     {@link VoidTransactionRequest }
     *     
     */
    public VoidTransactionRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(VoidTransactionRequest value) {
        this.request = value;
    }
