 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetWaiveVoidFeeStats_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetWaiveVoidFeeStats")
public class GetWaiveVoidFeeStats {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetWaiveVoidFeeStatsRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetWaiveVoidFeeStatsRequest }
     */
    public GetWaiveVoidFeeStatsRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetWaiveVoidFeeStatsRequest }
     */
    public void setRequest(GetWaiveVoidFeeStatsRequest value) {
        this.request = value;
    }
