 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}RemovePCD_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class RemovePCD {
     ...
     * @return
     *     possible object is
     *     {@link RemovePCDRequest }
     *     
     */
    public RemovePCDRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(RemovePCDRequest value) {
        this.request = value;
    }
