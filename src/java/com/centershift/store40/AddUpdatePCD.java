 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}AddUpdatePCD_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AddUpdatePCD {
     ...
     *
     * @return possible object is
     *         {@link AddUpdatePCDRequest }
     */
    public AddUpdatePCDRequest getRequest() {
        return request;
    }
     ...
     *              {@link AddUpdatePCDRequest }
     */
    public void setRequest(AddUpdatePCDRequest value) {
        this.request = value;
    }
