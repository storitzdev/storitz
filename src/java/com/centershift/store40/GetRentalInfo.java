 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetRentalInfo_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetRentalInfo")
public class GetRentalInfo {
    ...
    protected GetRentalInfoRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetRentalInfoRequest }
     */
    public GetRentalInfoRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetRentalInfoRequest }
     */
    public void setRequest(GetRentalInfoRequest value) {
        this.request = value;
    }
