 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}RentalActivity_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "RentalActivity")
public class RentalActivity {
    ...
    protected RentalActivityRequest request;
     ...
     *
     * @return possible object is
     *         {@link RentalActivityRequest }
     */
    public RentalActivityRequest getRequest() {
        return request;
    }
     ...
     *              {@link RentalActivityRequest }
     */
    public void setRequest(RentalActivityRequest value) {
        this.request = value;
    }
