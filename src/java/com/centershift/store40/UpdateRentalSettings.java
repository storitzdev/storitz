 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}UpdateRentalSettings_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UpdateRentalSettings")
public class UpdateRentalSettings {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected UpdateRentalSettingsRequest request;
     ...
     * @return
     *     possible object is
     *     {@link UpdateRentalSettingsRequest }
     *     
     */
    public UpdateRentalSettingsRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(UpdateRentalSettingsRequest value) {
        this.request = value;
    }
