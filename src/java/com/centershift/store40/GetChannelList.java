 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetChannelList_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetChannelList")
public class GetChannelList {
    ...
    protected GetChannelListRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetChannelListRequest }
     */
    public GetChannelListRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetChannelListRequest }
     */
    public void setRequest(GetChannelListRequest value) {
        this.request = value;
    }
