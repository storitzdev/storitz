 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetUnitData_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetUnitData")
public class GetUnitData {
    ...
    protected GetUnitDataRequest request;
     ...
     *     
     */
    public GetUnitDataRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetUnitDataRequest value) {
        this.request = value;
    }
