 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetAvailableDeposits_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetAvailableDeposits")
public class GetAvailableDeposits {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetAvailableDepositsRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetAvailableDepositsRequest }
     *     
     */
    public GetAvailableDepositsRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetAvailableDepositsRequest value) {
        this.request = value;
    }
