 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}getTenantDocList_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getTenantLetterList")
public class GetTenantLetterList {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetTenantDocListRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetTenantDocListRequest }
     *     
     */
    public GetTenantDocListRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetTenantDocListRequest value) {
        this.request = value;
    }
