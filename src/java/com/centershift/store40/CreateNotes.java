 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}CreateNotes_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CreateNotes {
    ...
    protected CreateNotesRequest request;
     ...
     *
     * @return possible object is
     *         {@link CreateNotesRequest }
     */
    public CreateNotesRequest getRequest() {
        return request;
    }
     ...
     *              {@link CreateNotesRequest }
     */
    public void setRequest(CreateNotesRequest value) {
        this.request = value;
    }
