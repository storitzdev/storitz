 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetSiteAttributes_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetSiteAttributes")
public class GetSiteAttributes {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetSiteAttributesRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetSiteAttributesRequest }
     *     
     */
    public GetSiteAttributesRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetSiteAttributesRequest value) {
        this.request = value;
    }
