 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetAppliedServices_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetAppliedServices")
public class GetAppliedServices {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetAppliedServicesRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetAppliedServicesRequest }
     *     
     */
    public GetAppliedServicesRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetAppliedServicesRequest value) {
        this.request = value;
    }
