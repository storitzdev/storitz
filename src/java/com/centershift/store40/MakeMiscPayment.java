 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}MakeMiscPayment_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "MakeMiscPayment")
public class MakeMiscPayment {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected MakeMiscPaymentRequest request;
     ...
     *
     * @return possible object is
     *         {@link MakeMiscPaymentRequest }
     */
    public MakeMiscPaymentRequest getRequest() {
        return request;
    }
     ...
     *              {@link MakeMiscPaymentRequest }
     */
    public void setRequest(MakeMiscPaymentRequest value) {
        this.request = value;
    }
