 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetEcommRentalInfo_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetEcommRentalInfo")
public class GetEcommRentalInfo {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetEcommRentalInfoRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetEcommRentalInfoRequest }
     */
    public GetEcommRentalInfoRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetEcommRentalInfoRequest }
     */
    public void setRequest(GetEcommRentalInfoRequest value) {
        this.request = value;
    }
