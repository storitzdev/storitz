 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}MakeMultipleReservations_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "MakeMultipleReservations")
public class MakeMultipleReservations {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected MakeMultipleReservationsRequest request;
     ...
     * @return
     *     possible object is
     *     {@link MakeMultipleReservationsRequest }
     *     
     */
    public MakeMultipleReservationsRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(MakeMultipleReservationsRequest value) {
        this.request = value;
    }
