 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}CancelInsurance_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CancelInsurance")
public class CancelInsurance {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected CancelInsuranceRequest request;
     ...
     *
     * @return possible object is
     *         {@link CancelInsuranceRequest }
     */
    public CancelInsuranceRequest getRequest() {
        return request;
    }
     ...
     *              {@link CancelInsuranceRequest }
     */
    public void setRequest(CancelInsuranceRequest value) {
        this.request = value;
    }
