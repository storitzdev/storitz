 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetAssessmentsByID_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetAssessmentsByID")
public class GetAssessmentsByID {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetAssessmentsByIDRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetAssessmentsByIDRequest }
     */
    public GetAssessmentsByIDRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetAssessmentsByIDRequest }
     */
    public void setRequest(GetAssessmentsByIDRequest value) {
        this.request = value;
    }
