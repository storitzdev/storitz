 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetAuctions_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetAuctions")
public class GetAuctions {
    ...
    protected GetAuctionsRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetAuctionsRequest }
     */
    public GetAuctionsRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetAuctionsRequest }
     */
    public void setRequest(GetAuctionsRequest value) {
        this.request = value;
    }
