 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetTotalDue_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetTotalDuePastDue")
public class GetTotalDuePastDue {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetTotalDueRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetTotalDueRequest }
     */
    public GetTotalDueRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetTotalDueRequest }
     */
    public void setRequest(GetTotalDueRequest value) {
        this.request = value;
    }
