 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}UpdateUnitStatusExpanded_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UpdateUnitStatusExpanded")
public class UpdateUnitStatusExpanded {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected UpdateUnitStatusExpandedRequest request;
     ...
     * @return
     *     possible object is
     *     {@link UpdateUnitStatusExpandedRequest }
     *     
     */
    public UpdateUnitStatusExpandedRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(UpdateUnitStatusExpandedRequest value) {
        this.request = value;
    }
