 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetAvailableRetailItems_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetAvailableRetailItems")
public class GetAvailableRetailItems {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetAvailableRetailItemsRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetAvailableRetailItemsRequest }
     *     
     */
    public GetAvailableRetailItemsRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetAvailableRetailItemsRequest value) {
        this.request = value;
    }
