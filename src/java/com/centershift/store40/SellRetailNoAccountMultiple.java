 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}SellRetailNoAccountMultiple_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SellRetailNoAccountMultiple")
public class SellRetailNoAccountMultiple {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected SellRetailNoAccountMultipleRequest request;
     ...
     *
     * @return possible object is
     *         {@link SellRetailNoAccountMultipleRequest }
     */
    public SellRetailNoAccountMultipleRequest getRequest() {
        return request;
    }
     ...
     *              {@link SellRetailNoAccountMultipleRequest }
     */
    public void setRequest(SellRetailNoAccountMultipleRequest value) {
        this.request = value;
    }
