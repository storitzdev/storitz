 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}ReassignRental_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ReassignRental")
public class ReassignRental {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected ReassignRentalRequest request;
     ...
     *
     * @return possible object is
     *         {@link ReassignRentalRequest }
     */
    public ReassignRentalRequest getRequest() {
        return request;
    }
     ...
     *              {@link ReassignRentalRequest }
     */
    public void setRequest(ReassignRentalRequest value) {
        this.request = value;
    }
