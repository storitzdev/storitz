 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}AddUpdateMerchandiseItems_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "AddUpdateMerchandiseItems")
public class AddUpdateMerchandiseItems {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected AddUpdateMerchandiseItemsRequest request;
     ...
     * @return
     *     possible object is
     *     {@link AddUpdateMerchandiseItemsRequest }
     *     
     */
    public AddUpdateMerchandiseItemsRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(AddUpdateMerchandiseItemsRequest value) {
        this.request = value;
    }
