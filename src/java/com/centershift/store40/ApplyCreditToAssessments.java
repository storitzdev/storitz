 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}ApplyCreditToAssessments_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ApplyCreditToAssessments")
public class ApplyCreditToAssessments {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected ApplyCreditToAssessmentsRequest request;
     ...
     *
     * @return possible object is
     *         {@link ApplyCreditToAssessmentsRequest }
     */
    public ApplyCreditToAssessmentsRequest getRequest() {
        return request;
    }
     ...
     *              {@link ApplyCreditToAssessmentsRequest }
     */
    public void setRequest(ApplyCreditToAssessmentsRequest value) {
        this.request = value;
    }
