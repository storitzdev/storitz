 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetAvailableDiscounts_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetAvailableDiscounts")
public class GetAvailableDiscounts {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetAvailableDiscountsRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetAvailableDiscountsRequest }
     *     
     */
    public GetAvailableDiscountsRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetAvailableDiscountsRequest value) {
        this.request = value;
    }
