 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetAuctionRentals_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetAuctionRentals")
public class GetAuctionRentals {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetAuctionRentalsRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetAuctionRentalsRequest }
     */
    public GetAuctionRentalsRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetAuctionRentalsRequest }
     */
    public void setRequest(GetAuctionRentalsRequest value) {
        this.request = value;
    }
