 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}FIUChecksum_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "FIUChecksumUpdate")
public class FIUChecksumUpdate {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected FIUChecksumRequest request;
     ...
     *
     * @return possible object is
     *         {@link FIUChecksumRequest }
     */
    public FIUChecksumRequest getRequest() {
        return request;
    }
     ...
     *              {@link FIUChecksumRequest }
     */
    public void setRequest(FIUChecksumRequest value) {
        this.request = value;
    }
