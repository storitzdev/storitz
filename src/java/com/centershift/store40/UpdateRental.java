 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}UpdateRental_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UpdateRental")
public class UpdateRental {
    ...
    protected UpdateRentalRequest request;
     ...
     * @return
     *     possible object is
     *     {@link UpdateRentalRequest }
     *     
     */
    public UpdateRentalRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(UpdateRentalRequest value) {
        this.request = value;
    }
