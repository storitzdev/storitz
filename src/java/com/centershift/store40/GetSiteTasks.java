 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetSiteTasks_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetSiteTasks {
     ...
     *
     * @return possible object is
     *         {@link GetSiteTasksRequest }
     */
    public GetSiteTasksRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetSiteTasksRequest }
     */
    public void setRequest(GetSiteTasksRequest value) {
        this.request = value;
    }
