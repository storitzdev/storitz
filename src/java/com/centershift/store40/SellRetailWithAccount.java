 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}SellRetailWithAccount_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SellRetailWithAccount")
public class SellRetailWithAccount {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected SellRetailWithAccountRequest request;
     ...
     */
    public SellRetailWithAccountRequest getRequest() {
        return request;
    }
     ...
     *              {@link SellRetailWithAccountRequest }
     */
    public void setRequest(SellRetailWithAccountRequest value) {
        this.request = value;
    }
