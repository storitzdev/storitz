 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}getLeaseTemplateInfo_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getLeaseTemplateInfo")
public class GetLeaseTemplateInfo {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetLeaseTemplateInfoRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetLeaseTemplateInfoRequest }
     */
    public GetLeaseTemplateInfoRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetLeaseTemplateInfoRequest }
     */
    public void setRequest(GetLeaseTemplateInfoRequest value) {
        this.request = value;
    }
