 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}RollbackUnitTransfer_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "RollbackUnitTransfer")
public class RollbackUnitTransfer {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected RollbackUnitTransferRequest request;
     ...
     *
     * @return possible object is
     *         {@link RollbackUnitTransferRequest }
     */
    public RollbackUnitTransferRequest getRequest() {
        return request;
    }
     ...
     *              {@link RollbackUnitTransferRequest }
     */
    public void setRequest(RollbackUnitTransferRequest value) {
        this.request = value;
    }
