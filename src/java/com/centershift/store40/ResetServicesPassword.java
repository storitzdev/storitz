 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}ResetServicesPassword_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ResetServicesPassword")
public class ResetServicesPassword {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected ResetServicesPasswordRequest request;
     ...
     * @return
     *     possible object is
     *     {@link ResetServicesPasswordRequest }
     *     
     */
    public ResetServicesPasswordRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(ResetServicesPasswordRequest value) {
        this.request = value;
    }
