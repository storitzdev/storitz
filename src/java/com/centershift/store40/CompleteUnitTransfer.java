 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}CompleteUnitTransfer_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CompleteUnitTransfer")
public class CompleteUnitTransfer {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected CompleteUnitTransferRequest request;
     ...
     * @return
     *     possible object is
     *     {@link CompleteUnitTransferRequest }
     *     
     */
    public CompleteUnitTransferRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(CompleteUnitTransferRequest value) {
        this.request = value;
    }
