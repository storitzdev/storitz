 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}ReturnRetailItems_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ReturnRetailItems")
public class ReturnRetailItems {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected ReturnRetailItemsRequest request;
     ...
     *
     * @return possible object is
     *         {@link ReturnRetailItemsRequest }
     */
    public ReturnRetailItemsRequest getRequest() {
        return request;
    }
     ...
     *              {@link ReturnRetailItemsRequest }
     */
    public void setRequest(ReturnRetailItemsRequest value) {
        this.request = value;
    }
