 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}UpdateInsurance_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UpdateInsurance")
public class UpdateInsurance {
    ...
    protected UpdateInsuranceRequest request;
     ...
     * @return
     *     possible object is
     *     {@link UpdateInsuranceRequest }
     *     
     */
    public UpdateInsuranceRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(UpdateInsuranceRequest value) {
        this.request = value;
    }
