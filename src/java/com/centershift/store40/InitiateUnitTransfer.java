 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}InitiateUnitTransfer_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "InitiateUnitTransfer")
public class InitiateUnitTransfer {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected InitiateUnitTransferRequest request;
     ...
     * @return
     *     possible object is
     *     {@link InitiateUnitTransferRequest }
     *     
     */
    public InitiateUnitTransferRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(InitiateUnitTransferRequest value) {
        this.request = value;
    }
