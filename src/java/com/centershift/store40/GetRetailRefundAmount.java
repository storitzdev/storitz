 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetRetailRefundAmount_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetRetailRefundAmount")
public class GetRetailRefundAmount {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetRetailRefundAmountRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetRetailRefundAmountRequest }
     */
    public GetRetailRefundAmountRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetRetailRefundAmountRequest }
     */
    public void setRequest(GetRetailRefundAmountRequest value) {
        this.request = value;
    }
