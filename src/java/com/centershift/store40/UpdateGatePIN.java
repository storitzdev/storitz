 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}UpdateGatePIN_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class UpdateGatePIN {
     ...
     * @return
     *     possible object is
     *     {@link UpdateGatePINRequest }
     *     
     */
    public UpdateGatePINRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(UpdateGatePINRequest value) {
        this.request = value;
    }
