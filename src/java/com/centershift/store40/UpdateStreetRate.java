 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}UpdateStreetRate_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UpdateStreetRate")
public class UpdateStreetRate {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected UpdateStreetRateRequest request;
     ...
     *
     * @return possible object is
     *         {@link UpdateStreetRateRequest }
     */
    public UpdateStreetRateRequest getRequest() {
        return request;
    }
     ...
     *              {@link UpdateStreetRateRequest }
     */
    public void setRequest(UpdateStreetRateRequest value) {
        this.request = value;
    }
