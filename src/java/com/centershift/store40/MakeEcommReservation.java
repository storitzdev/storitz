 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}MakeEcommReservation_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "MakeEcommReservation")
public class MakeEcommReservation {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected MakeEcommReservationRequest request;
     ...
     *
     * @return possible object is
     *         {@link MakeEcommReservationRequest }
     */
    public MakeEcommReservationRequest getRequest() {
        return request;
    }
     ...
     *              {@link MakeEcommReservationRequest }
     */
    public void setRequest(MakeEcommReservationRequest value) {
        this.request = value;
    }
