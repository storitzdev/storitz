 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetAutoPaySettings_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetAutoPaySettings")
public class GetAutoPaySettings {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetAutoPaySettingsRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetAutoPaySettingsRequest }
     *     
     */
    public GetAutoPaySettingsRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetAutoPaySettingsRequest value) {
        this.request = value;
    }
