 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}CreateDemoUser_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CreateDemoUser")
public class CreateDemoUser {
    ...
    protected CreateDemoUserRequest request;
     ...
     * @return
     *     possible object is
     *     {@link CreateDemoUserRequest }
     *     
     */
    public CreateDemoUserRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(CreateDemoUserRequest value) {
        this.request = value;
    }
