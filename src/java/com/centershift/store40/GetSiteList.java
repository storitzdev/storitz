 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetSiteList_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetSiteList")
public class GetSiteList {
    ...
    protected GetSiteListRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetSiteListRequest }
     */
    public GetSiteListRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetSiteListRequest }
     */
    public void setRequest(GetSiteListRequest value) {
        this.request = value;
    }
