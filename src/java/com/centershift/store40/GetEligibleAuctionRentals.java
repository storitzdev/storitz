 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetEligibleAuctionRentals_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetEligibleAuctionRentals")
public class GetEligibleAuctionRentals {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetEligibleAuctionRentalsRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetEligibleAuctionRentalsRequest }
     */
    public GetEligibleAuctionRentalsRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetEligibleAuctionRentalsRequest }
     */
    public void setRequest(GetEligibleAuctionRentalsRequest value) {
        this.request = value;
    }
