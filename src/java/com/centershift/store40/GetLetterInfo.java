 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetLetterInfo_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetLetterInfo {
     ...
     *
     * @return possible object is
     *         {@link GetLetterInfoRequest }
     */
    public GetLetterInfoRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetLetterInfoRequest }
     */
    public void setRequest(GetLetterInfoRequest value) {
        this.request = value;
    }
