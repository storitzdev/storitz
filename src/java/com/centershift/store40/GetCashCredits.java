 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetCashCredits_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetCashCredits")
public class GetCashCredits {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetCashCreditsRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetCashCreditsRequest }
     *     
     */
    public GetCashCreditsRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetCashCreditsRequest value) {
        this.request = value;
    }
