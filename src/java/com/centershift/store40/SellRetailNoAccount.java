 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}SellRetailNoAccount_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SellRetailNoAccount")
public class SellRetailNoAccount {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected SellRetailNoAccountRequest request;
     ...
     *     
     */
    public SellRetailNoAccountRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(SellRetailNoAccountRequest value) {
        this.request = value;
    }
