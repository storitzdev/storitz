 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}AddInsurance_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "AddInsurance")
public class AddInsurance {
    ...
    protected AddInsuranceRequest request;
     ...
     *     
     */
    public AddInsuranceRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(AddInsuranceRequest value) {
        this.request = value;
    }
