 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetUnitFeatures_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetUnitFeatures")
public class GetUnitFeatures {
    ...
    protected GetUnitFeaturesRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetUnitFeaturesRequest }
     */
    public GetUnitFeaturesRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetUnitFeaturesRequest }
     */
    public void setRequest(GetUnitFeaturesRequest value) {
        this.request = value;
    }
