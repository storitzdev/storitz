 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}getLtrTemplateInfo_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getReceiptTemplateInfo")
public class GetReceiptTemplateInfo {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetLtrTemplateInfoRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetLtrTemplateInfoRequest }
     *     
     */
    public GetLtrTemplateInfoRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetLtrTemplateInfoRequest value) {
        this.request = value;
    }
