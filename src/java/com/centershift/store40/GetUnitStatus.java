 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetUnitStatus_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetUnitStatus {
     ...
     * @return
     *     possible object is
     *     {@link GetUnitStatusRequest }
     *     
     */
    public GetUnitStatusRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetUnitStatusRequest value) {
        this.request = value;
    }
