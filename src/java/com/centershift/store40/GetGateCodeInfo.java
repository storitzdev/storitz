 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}GetGateCodeInfo_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetGateCodeInfo")
public class GetGateCodeInfo {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected GetGateCodeInfoRequest request;
     ...
     *
     * @return possible object is
     *         {@link GetGateCodeInfoRequest }
     */
    public GetGateCodeInfoRequest getRequest() {
        return request;
    }
     ...
     *              {@link GetGateCodeInfoRequest }
     */
    public void setRequest(GetGateCodeInfoRequest value) {
        this.request = value;
    }
