 ...
 *         &lt;element name="Request" type="{http://www.centershift.com/STORE40/}createOrViewLtr_Request"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "createAndViewLetter")
public class CreateAndViewLetter {

    @XmlElement(name = "LookupUser_Request", required = true)
    protected LookupUserRequest lookupUserRequest;
    @XmlElement(name = "Request", required = true)
    protected CreateOrViewLtrRequest request;
     ...
     * @return
     *     possible object is
     *     {@link CreateOrViewLtrRequest }
     *     
     */
    public CreateOrViewLtrRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(CreateOrViewLtrRequest value) {
        this.request = value;
    }
