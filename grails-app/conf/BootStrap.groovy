...
class BootStrap {
  ...
  def init = { servletContext ->
    ...
    if (!User.findByUsername('admin')) {
      def admin = new User(username: 'admin', password: springSecurityService.encodePassword('WWCharter'), userRealName: 'Administrator', enabled: true, email: 'charlie@storitz.com', accountExpired: false, accountLocked: false, passwordExpired: false)
      admin.manager = admin;
  ...
  def setupUnitTypes2() {
    ...
    new UnitTypeLookup(id: 799, description: "Ground, Air Cooled", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 800, description: "Special", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 801, description: "Upper-Ground Level CC", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 802, description: "Lower- Ground Level CC", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 803, description: "Upper-Ground Level", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 804, description: "Elevator-Air Cooled", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 805, description: "Elevator Air Conditioned", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 806, description: "Ground, Air Cooled", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 807, description: "HBP-Heated Basement Premium", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 808, description: "NDNU-Non-Climate Down Normal", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 809, description: "COP-Climate Outside Premium", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 810, description: "NOEMA-Non-Climate Outside Economy", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 811, description: "P4X4", unitType: UnitType.UNCOVERED, searchType: SearchType.PARKING, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 812, description: "CC Preferred", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 813, description: "CC Economy", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    ...
    new UnitTypeLookup(id: 836, description: "AAA", unitType: UnitType.UNDEFINED, searchType: SearchType.UNDEFINED, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 837, description: "CBE", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 838, description: "CBN", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 839, description: "CBP", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 840, description: "CDE", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 841, description: "CDEM", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 842, description: "CDN", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 843, description: "CDNA", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 844, description: "CDNB", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 845, description: "CDNE", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 846, description: "CDNM", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 847, description: "CDNU", unitType: UnitType.UNDEFINED, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 848, description: "CDNW", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 849, description: "CDP", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 850, description: "CDPB", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 851, description: "CDPM", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 852, description: "CEE", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 853, description: "CEE-Climate Up Economy", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 854, description: "CEEA", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 855, description: "CEEM", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 856, description: "CEN", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 857, description: "CENA", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 858, description: "CENM", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 859, description: "CENU", unitType: UnitType.UNDEFINED, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 860, description: "CEP", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 861, description: "CEPM", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 862, description: "CLE", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 863, description: "CLN", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 864, description: "CLNM", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 865, description: "CON", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 866, description: "CONB", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 867, description: "CONL", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 868, description: "CONM", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 869, description: "COP", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 870, description: "CSN", unitType: UnitType.UNDEFINED, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 871, description: "CSNU", unitType: UnitType.UNDEFINED, searchType: SearchType.STORAGE, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 872, description: "CXN", unitType: UnitType.UNDEFINED, searchType: SearchType.LOCKER, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 873, description: "CYN", unitType: UnitType.UNDEFINED, searchType: SearchType.LOCKER, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 874, description: "CZN", unitType: UnitType.UNDEFINED, searchType: SearchType.LOCKER, tempControlled: true).save(validate: false)
    new UnitTypeLookup(id: 875, description: "DDN", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 876, description: "DDNM", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 877, description: "DDNU", unitType: UnitType.UNDEFINED, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 878, description: "DDP", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 879, description: "HBN", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 880, description: "HBNM", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 881, description: "HDN", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 882, description: "HDNM", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 883, description: "HDP", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 884, description: "HDPU", unitType: UnitType.UNDEFINED, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 885, description: "HEN", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 886, description: "HON", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 887, description: "HSN", unitType: UnitType.UNDEFINED, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 888, description: "HYN", unitType: UnitType.UNDEFINED, searchType: SearchType.LOCKER, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 889, description: "MAA", unitType: UnitType.UNDEFINED, searchType: SearchType.UNDEFINED, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 890, description: "NBM", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 891, description: "NDE", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 892, description: "NDEM", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 893, description: "NDN", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 894, description: "NDNA", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 895, description: "NDNB", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 896, description: "NDNM", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 897, description: "NDNO", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 898, description: "NDP", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 899, description: "NDPM", unitType: UnitType.INTERIOR, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 900, description: "NEE", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
  }
  ...
  def setupUnitTypes3() {
    ...
    new UnitTypeLookup(id: 904, description: "NEP", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 905, description: "NLE", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 906, description: "NLN", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 907, description: "NLNM", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 908, description: "NLP", unitType: UnitType.UPPER, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 909, description: "NOE", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 910, description: "NON", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 911, description: "NONA", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 912, description: "NONB", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 913, description: "NOND", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 914, description: "NONE", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 915, description: "NONH", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 916, description: "NONL", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 917, description: "NONM", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 918, description: "NONO", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 919, description: "NONU", unitType: UnitType.UNDEFINED, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 920, description: "NONW", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 921, description: "NOP", unitType: UnitType.DRIVEUP, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 922, description: "NSE", unitType: UnitType.UNDEFINED, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 923, description: "NSN", unitType: UnitType.UNDEFINED, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 924, description: "NSNM", unitType: UnitType.UNDEFINED, searchType: SearchType.STORAGE, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 925, description: "NXN", unitType: UnitType.UNDEFINED, searchType: SearchType.LOCKER, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 926, description: "NXP", unitType: UnitType.UNDEFINED, searchType: SearchType.LOCKER, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 927, description: "NYN", unitType: UnitType.UNDEFINED, searchType: SearchType.LOCKER, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 928, description: "NYP", unitType: UnitType.UNDEFINED, searchType: SearchType.LOCKER, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 929, description: "OAA", unitType: UnitType.UNDEFINED, searchType: SearchType.UNDEFINED, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 930, description: "PCN", unitType: UnitType.COVERED, searchType: SearchType.PARKING, tempControlled: false).save(validate: false)
    new UnitTypeLookup(id: 931, description: "PIN", unitType: UnitType.COVERED, searchType: SearchType.PARKING, tempControlled: false).save(validate: false)
