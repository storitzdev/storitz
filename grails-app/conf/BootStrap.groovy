...
class BootStrap {
  ...
  def init = { servletContext ->
    ...
    if (StorageSize.list().size() == 0) {
      new StorageSize( description:'Choose the size you need', width: 0, length: 0).save();
  ...
  def setupUnitTypes2() {
    ...
    new UnitTypeLookup(id:599, description:"Dover 2", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:600, description:"Dover2- In", unitType:UnitType.INTERIOR, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:601, description:"Drive-up Self Storage", unitType:UnitType.DRIVEUP, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:602, description:"Interior Access", unitType:UnitType.INTERIOR, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:603, description:"Climate Multi Dr", unitType:UnitType.DRIVEUP, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:604, description:"Warehouse", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:605, description:"SS-1stFlr IN", unitType:UnitType.INTERIOR, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:606, description:"SS-1stFlr OUT", unitType:UnitType.DRIVEUP, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:607, description:"SS-2ndFlr UP", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:608, description:"Comp-Manager", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:609, description:"Inside Units", unitType:UnitType.INTERIOR, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:610, description:"Odd Sizes", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:611, description:"Company Units", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:612, description:"Indoor  Parking", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:613, description:"Office Warehouse", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    ...
    new UnitTypeLookup(id:621, description:"Elevator Access", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:622, description:"Ground Level, Refrigeration", unitType:UnitType.INTERIOR, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:623, description:"CSNM-Climate UP Normal", unitType:UnitType.UPPER, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:624, description:"In", unitType:UnitType.INTERIOR, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:625, description:"CCDn", unitType:UnitType.INTERIOR, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:626, description:"DU- Drive up Access", unitType:UnitType.DRIVEUP, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:627, description:"UL-EL- Upper Level", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:628, description:"IN- Inside Hall 1st Floor", unitType:UnitType.INTERIOR, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:629, description:"UL-EL- Upper Level 2nd & 3rd", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:630, description:"UL- Upper Level", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:631, description:"EL - 2nd Floor", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:632, description:"Outside Parking", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:633, description:"1st Floor EZ Access", unitType:UnitType.INTERIOR, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:634, description:"2nd Floor Standard Access", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:635, description:"2nd Floor EZ Access", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:636, description:"Bldg B Drive-Up", unitType:UnitType.DRIVEUP, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:637, description:"Bldg A Drive-Up", unitType:UnitType.DRIVEUP, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:638, description:"Bldg A Upper Floor", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:639, description:"Bldg A Ground Level", unitType:UnitType.INTERIOR, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:640, description:"Bldg B Ground Level", unitType:UnitType.INTERIOR, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:641, description:"1st Floor Hall EZ Access", unitType:UnitType.INTERIOR, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:642, description:"1st Floor Standard Access", unitType:UnitType.INTERIOR, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:643, description:"2nd Floor Hall EZ Access", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:644, description:"2nd Floor Standard Access", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:645, description:"3rd Floor Hall EZ Access", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:646, description:"3rd Floor Standard Access", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:647, description:"Drive Up Access Portable", unitType:UnitType.DRIVEUP, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:648, description:"Personal Vault", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:649, description:"Lower Level EZ Access", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:650, description:"CCUp", unitType:UnitType.UPPER, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:651, description:"CCUpVal", unitType:UnitType.UPPER, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:652, description:"CCDnVal", unitType:UnitType.INTERIOR, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:653, description:"PA-Parking", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:654, description:"AirCDn", unitType:UnitType.INTERIOR, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:655, description:"PrkgUnc", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:656, description:"NC EXT 10", unitType:UnitType.DRIVEUP, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:657, description:"CC IN 10", unitType:UnitType.INTERIOR, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:658, description:"PrkgCov", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:659, description:"CC Locker", unitType:UnitType.UNDEFINED, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:660, description:"In val", unitType:UnitType.INTERIOR, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:661, description:"OutHbay", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:662, description:"Out val", unitType:UnitType.DRIVEUP, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:663, description:"Out prem", unitType:UnitType.DRIVEUP, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:664, description:"CCDnPrem", unitType:UnitType.INTERIOR, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:665, description:"In prem", unitType:UnitType.INTERIOR, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:666, description:"ELEC", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:667, description:"CCUpElev", unitType:UnitType.UPPER, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:668, description:"CCUpElevPrem", unitType:UnitType.UPPER, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:669, description:"CCOut", unitType:UnitType.DRIVEUP, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:670, description:"RVopen", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:671, description:"RVcanopy", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:672, description:"Inside Units (non c/c)", unitType:UnitType.INTERIOR, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:673, description:"Climate Control-upstairs", unitType:UnitType.UPPER, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:674, description:"1st Floor Non-Climate Controlled", unitType:UnitType.INTERIOR, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:675, description:"Parking Unconvered", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:676, description:"24 HR Out", unitType:UnitType.DRIVEUP, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:677, description:"CC IN 5", unitType:UnitType.INTERIOR, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:678, description:"Parking - Covered", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:679, description:"CCUpPrem", unitType:UnitType.UPPER, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:680, description:"AirCUpElev", unitType:UnitType.UPPER, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:681, description:"CCDI", unitType:UnitType.INTERIOR, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:682, description:"CCUIE", unitType:UnitType.INTERIOR, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:683, description:"CCUI", unitType:UnitType.UPPER, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:684, description:"CCDIE", unitType:UnitType.INTERIOR, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:685, description:"Old Outside", unitType:UnitType.DRIVEUP, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:686, description:"Parking Covered", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:687, description:"NDY-Non-Climate Down Ladder Unit", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:688, description:"AirCDnPrem", unitType:UnitType.INTERIOR, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:688, description:"AirCDnVal", unitType:UnitType.INTERIOR, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:689, description:"AirCUpVElev", unitType:UnitType.UPPER, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:690, description:"AirCUpPElev", unitType:UnitType.UPPER, tempControlled:true).save(validate:false)
    new UnitTypeLookup(id:691, description:"OffWhse", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:692, description:"Locker 6 FT Upper", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:693, description:"InUpVal", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:694, description:"InUpLift", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:695, description:"In up lift prem", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:696, description:"StrFrnt", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:697, description:"3rd Floor EZ Access", unitType:UnitType.UPPER, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:698, description:"Wine - Top 18 Case", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:699, description:"Wine - Bottom 36 Case", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:700, description:"Wine - Full 54 Case", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:701, description:"Locker 1st Floor - Hall EZ Access", unitType:UnitType.UNDEFINED, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:702, description:"DU- Irregular Corner Unit", unitType:UnitType.DRIVEUP, tempControlled:false).save(validate:false)
    new UnitTypeLookup(id:703, description:"IN- Inside Hall", unitType:UnitType.INTERIOR, tempControlled:false).save(validate:false)
