...
<html>
<head>
  <g:set var="title" value="Edit Uncle Bob's Feed" scope="request"/>
</head>
<body>
<div id="body">
  <div class="stcontent">
    <div class="buttons">
      ...
      <span class="button"><g:link action="create">Create Uncle Bob's Feed</g:link></span>
    </div>
    <div class="body">

      <div class="price_options checkout_header white">
        Edit Uncle Bob's Feed
      </div>
      ...
      <g:form method="post">
        ...
        <g:hiddenField name="version" value="${uncleBobsInstance?.version}"/>
        ...
        <div class="checkout_fields">
          <div style="width:300px;" class="checkout_value ${hasErrors(bean: uncleBobsInstance, field: 'manager', 'errors')}">
            <g:select name="manager.id" style="width:280px;" from="${com.storitz.UserRole.getUsersByRoleName('ROLE_MANAGER')}" optionKey="id" optionValue="username" value="${uncleBobsInstance?.manager?.id}" noSelection="['null': '']"/>
          </div>
        ...
        <div class="checkout_section_header">
          uncleBobs Account Information
        </div>

        <div class="formInstructions">
          This information should come from uncleBobs and the operator
        </div>

        <div class="checkout_fields">
          <div style="width:200px;" class="checkout_value ${hasErrors(bean: uncleBobsInstance, field: 'UBCompanyName', 'errors')}">
            <g:textField name="UBCompanyName" style="width:180px;" value="${uncleBobsInstance?.UBCompanyName}"/>
          </div>
          <div style="clear:both;"></div>
        </div>
        ...
        <div class="checkout_labels">
          ...
          <div class="checkout_fields">
            <div style="width:300px;" class="checkout_value ${hasErrors(bean: uncleBobsInstance, field: 'reservationMoveInDescription', 'errors')}">
                <g:textArea name="reservationMoveInDescription" rows="5" cols="100"> ${uncleBobsInstance?.reservationMoveInDescription} </g:textArea>
            </div>
            <div style="clear:both;"></div>
          </div>
      ...
      <g:uploadForm action="uploadLogo" method="post" id="${uncleBobsInstance?.id}">
        <div class="checkout_section_header">
          Upload Logo
        </div>
        <div class="formInstructions">
