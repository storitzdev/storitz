    ...
    <div class="body">
        ...
        <table>
          ...
          <g:if test="${storageSiteInstance?.rentalAgreement}">
            ...
            <tr class="prop">
              ...
              <td valign="top" style="text-align: left;" class="value">
                <a href="${resource(file: storageSiteInstance?.rentalAgreement.src())}" onclick="window.open(this.href, '_blank');
          ...
          <sec:ifAnyGranted roles="ROLE_ADMIN, ROLE_MANAGER">
            ...
            <tr class="prop">
              ...
              <td valign="top" style="text-align: left;" class="value">
                <span>${storageSiteInstance.disabled ? 'Disabled' : 'Enabled'}</span>
              </td>
            </tr>
            <tr class="prop">
              <td valign="top" class="name"><g:message code="storageSite.allowPushPrice.label" default="Allow Push Pricing"/></td>
      ...
      <div class="buttons">
        <g:form>
          ...
          <span class="button"><a href="${createLink(action: "detail", params: [id: storageSiteInstance?.id, adminView: true])}" onclick="window.open(this.href, '_blank');
          return false;">User View</a></span>
        </g:form>
      </div>
    </div>
  </div>
