      ...
      <table>
        ...
        <g:if test="${storageSiteInstance?.rentalAgreement}">
          ...
          <tr class="prop">
            ...
            <td valign="top" style="text-align: left;" class="value">
              <a href="${resource(file:storageSiteInstance?.rentalAgreement.src())}" onclick="window.open(this.href,'_blank');return false;"><p:image src="icn_pdf.jpg" width="36" height="36" alt="PDF"/></a>
            </td>
