...
<html>
<head>
  <g:set var="title" value="Edit U-Store-It Feed" scope="request"/>
  ...
  <div class="stcontent">
    ...
    <div class="body">
      ...
      <g:form method="post">
        ...
        <div class="checkout_section_header">
          U-Store-It Account Information
        </div>

        <div class="formInstructions">
          This information should come from U-Store-It and the operator
        </div>
        ...
        <div class="checkout_labels">
          <div class="checkout_name" style="width:200px;">
            <label for="cshiftVersion">U-Store-It Version</label>
          </div>
        ...
        <div class="checkout_labels">
          ...
          <div class="checkout_fields">
            <div style="width:300px;" class="checkout_value ${hasErrors(bean: cshiftInstance, field: 'reservationMoveInDescription', 'errors')}">
                <g:textArea name="reservationMoveInDescription" rows="5" cols="100"> ${cshiftInstance?.reservationMoveInDescription} </g:textArea>
            </div>
            <div style="clear:both;"></div>
          </div>
