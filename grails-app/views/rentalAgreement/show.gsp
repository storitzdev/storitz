    ...
    <div class="dialog">
      <table>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value"><a href="${resource(file:rentalAgreementInstance.src())}" onclick="window.open(this.href,'_blank');return false;"><img src="${resource(dir:'images', file:'icn_pdf.jpg')}" alt="PDF"></a></td>
