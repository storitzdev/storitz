...
<head>
  <g:set var="title" value="Show Rental Agreement" scope="request"/>
    ...
    <div class="dialog">
      <table>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value"><a href="${resource(file:rentalAgreementInstance.src())}" onclick="window.open(this.href,'_blank');return false;"><storitz:image src="icn_pdf.jpg" width="36" height="36" alt="PDF"/></a></td>
