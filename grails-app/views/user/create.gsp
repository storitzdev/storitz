...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" >
  <head>
    ...
    <g:set var="title" value="Create User"/>
              ...
              <sec:ifAnyGranted roles="ROLE_ADMIN, ROLE_MANAGER">
                ...
                <div class="checkout_fields">
                  <div style="width:650px;" class="checkout_value">
                    <g:each var="notificationType" in="${notificationTypeList}">
                      <div style="margin: 0 1.5em;" class="left">
                        <g:checkBox name="${notificationType.notificationType}"/> &nbsp; ${notificationType.description}
                      </div>
                    </g:each>
                  </div>
                  <div style="clear:both; height:10px;"></div>
