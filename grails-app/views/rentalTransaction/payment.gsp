              ...
              <div style="margin: 5px 15px 20px 15px;">
                ...
                <div class="right">
                  ...
                  <div class="right transTotalMoveIn">
                    ...
                    <div class="left">
                      <a href="#" id="totalMoveInCost" onclick="Effect.toggle('costDetails', 'appear', { duration: 0.25 });
                      return false;"><g:formatNumber number="${moveInDetails.total()}" type="currency" currencyCode="USD"/></a>
                    </div>
                    <g:if test="${site.transactionType == TransactionType.RESERVATION}">
                      <div style="clear:both;"></div>
