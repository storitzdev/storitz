...
(function(a) {
    a.utils.extensionmap = {"3gp":"video/3gpp","3gpp":"video/3gpp","3g2":"video/3gpp2","3gpp2":"video/3gpp2",flv:"video/x-flv",f4a:"audio/mp4",f4b:"audio/mp4",f4p:"video/mp4",f4v:"video/mp4",mov:"video/quicktime",m4a:"audio/mp4",m4b:"audio/mp4",m4p:"audio/mp4",m4v:"video/mp4",mkv:"video/x-matroska",mp4:"video/mp4",sdp:"application/sdp",vp6:"video/x-vp6",aac:"audio/aac",mp3:"audio/mp3",ogg:"audio/ogg",ogv:"video/ogg",webm:"video/webm"}
})(jwplayer);
(function(b) {
    var a = [];
                    ...
                    if (s) {
                        for (var u in s) {
                            if (typeof s[u] == "function") {
                                s[u].call(this, {oldstate:t,newstate:q})
                            }
                        }
                    }
                }
    ...
    b.api.PlayerAPI.prototype = {container:undefined,options:undefined,id:undefined,getBuffer:function() {
        ...
        var c = this.getState();
        switch (c) {case b.api.events.state.PLAYING:case b.api.events.state.BUFFERING:this.callInternal("jwPause");break;case b.api.events.state.PAUSED:this.callInternal("jwPlay");break
        }
        return this
    },stop:function() {
...
(function(a) {
    ...
    a.embed.defaults = {width:400,height:300,players:[
        {type:"flash",src:"player.swf"},
        {type:"html5"}
    ],components:{controlbar:{position:"over"}}};
    a.embed.Embedder.prototype = {config:undefined,api:undefined,events:{},players:undefined,constructor:function(d) {
        this.api = d;
        ...
        if (c && c.type) {
            switch (c.type) {case"flash":if (a.utils.hasFlash()) {
                if (this.config.file && !this.config.provider) {
                    switch (a.utils.extension(this.config.file).toLowerCase()) {case"webm":case"ogv":case"ogg":this.config.provider = "video";break
                    }
                }
            ...
            }break;case"html5":if (a.utils.hasHTML5(this.config)) {
        ...
        return function(e) {
            if (c.playlist) {
                ...
                if (c.levels) {
                    ...
                    if (!d) {
                        d = {file:c.levels[0].file,provider:(c.provider ? c.provider : "video")}
                    }
                    if (!d.image) {
                        d.image = c.image
                    }
    ...
    a.embed.embedHTML5 = function(d, f, e) {
        if (a.html5) {
            d.innerHTML = "";
            var c = a.utils.extend({screencolor:"0x000000"}, e);
...
(function(b) {
    ...
    b.html5.view = function(p, n, e) {
        ...
        function x() {
            ...
            k.id = u.id + "_video";
            c(u, {position:"relative",height:v.height,width:v.width,padding:0,backgroundColor:C(),zIndex:0});
            function C() {
            ...
            c(k, {position:"absolute",width:v.width,height:v.height,top:0,left:0,zIndex:1,margin:"auto",display:"block"});
            b.utils.wrap(k, u);
        ...
        function g(C) {
            switch (C.keyCode) {case 27:if (s.jwGetFullscreen()) {
                s.jwSetFullscreen(false)
            }break;case 32:if (s.jwGetState() != b.api.events.state.IDLE && s.jwGetState() != b.api.events.state.PAUSED) {
                s.jwPause()
            } else {
                s.jwPlay()
            }break
        ...
        function h(F, C) {
            ...
            if (!v.fullscreen) {
                ...
                f = F;
                z = C;
                c(q, {top:0,bottom:0,left:0,right:0,width:F,height:C});
                c(u, {height:z,width:f});
                var D = l(r, E);
                if (D.length > 0) {
                    A += D.length;
                    l(j, D, true)
            ...
            for (var C in E) {
                ...
                if (v.plugins.object[I].getDisplayElement !== undefined) {
                    if (v.plugins.config[I].currentPosition.toUpperCase() !== b.html5.view.positions.NONE) {
                        ...
                        c(v.plugins.object[I].getDisplayElement(), {display:"none"})
                    }
                }
            }
            return D
        ...
        function j(C, D) {
            ...
            return{position:"absolute",width:(v.width - B(q.style.left) - B(q.style.right)),height:(v.height - B(q.style.top) - B(q.style.bottom)),zIndex:D}
        }

        function y(C, D) {
            return{position:"fixed",width:v.width,height:v.height,zIndex:D}
        }

        function w() {
            q.style.position = "absolute";
            var C = {position:"absolute",width:B(q.style.width),height:B(q.style.height),top:B(q.style.top),left:B(q.style.left)};
            c(v.getMedia().getDisplayElement(), C)
        }

        function d(D) {
            var E = {position:"absolute",margin:0,padding:0,top:null};
            var C = v.plugins.config[D].currentPosition.toLowerCase();
            switch (C.toUpperCase()) {case b.html5.view.positions.TOP:E.top = B(q.style.top);E.left = B(q.style.left);E.width = f - B(q.style.left) - B(q.style.right);E.height = v.plugins.object[D].height;q.style[C] = B(q.style[C]) + v.plugins.object[D].height + "px";q.style.height = B(q.style.height) - E.height + "px";break;case b.html5.view.positions.RIGHT:E.top = B(q.style.top);E.right = B(q.style.right);E.width = E.width = v.plugins.object[D].width;E.height = z - B(q.style.top) - B(q.style.bottom);q.style[C] = B(q.style[C]) + v.plugins.object[D].width + "px";q.style.width = B(q.style.width) - E.width + "px";break;case b.html5.view.positions.BOTTOM:E.bottom = B(q.style.bottom);E.left = B(q.style.left);E.width = f - B(q.style.left) - B(q.style.right);E.height = v.plugins.object[D].height;q.style[C] = B(q.style[C]) + v.plugins.object[D].height + "px";q.style.height = B(q.style.height) - E.height + "px";break;case b.html5.view.positions.LEFT:E.top = B(q.style.top);E.left = B(q.style.left);E.width = v.plugins.object[D].width;E.height = z - B(q.style.top) - B(q.style.bottom);q.style[C] = B(q.style[C]) + v.plugins.object[D].width + "px";q.style.width = B(q.style.width) - E.width + "px";break;default:break
            }
            return E
        }
        ...
        this.fullscreen = function(D) {
            if (navigator.vendor.indexOf("Apple") === 0) {
                ...
                if (D) {
                    ...
                    v.width = window.innerWidth;
                    v.height = window.innerHeight;
                    var C = {position:"fixed",width:"100%",height:"100%",top:0,left:0,zIndex:2147483000};
                    c(u, C);
                    C.zIndex = 1;
                    c(v.getMedia().getDisplayElement(), C);
                    C.zIndex = 2;
                    ...
                    v.width = f;
                    v.height = z;
                    c(u, {position:"relative",height:v.height,width:v.width,zIndex:0})
                }
                h(v.width, v.height)
            }
        }
    ...
    b.html5.view.positions = {TOP:"TOP",RIGHT:"RIGHT",BOTTOM:"BOTTOM",LEFT:"LEFT",OVER:"OVER",NONE:"NONE"}
})(jwplayer);
(function(a) {
    var b = {backgroundcolor:"",margin:10,font:"Arial,sans-serif",fontsize:10,fontcolor:parseInt("000000", 16),fontstyle:"normal",fontweight:"bold",buttoncolor:parseInt("ffffff", 16),position:a.html5.view.positions.BOTTOM,idlehide:false,layout:{left:{position:"left",elements:[
    ...
    a.html5.controlbar = function(j, L) {
        ...
        function H() {
            ...
            I = 0;
            if (!n) {
                var V = {height:i.skin.getSkinElement("controlbar", "background").height,backgroundColor:A.backgroundcolor};
                P = document.createElement("div");
                P.id = i.id + "_jwplayer_controlbar";
                _css(P, V)
            }
            v("capLeft", "left", false, P);
            var W = {position:"absolute",height:i.skin.getSkinElement("controlbar", "background").height,background:" url(" + i.skin.getSkinElement("controlbar", "background").src + ") repeat-x center left",left:i.skin.getSkinElement("controlbar", "capLeft").width};
            N("elements", P, W);
        ...
        this.resize = function(X, V) {
            ...
            x();
            var W = u();
            D({id:i.id,duration:Q,position:h});
            r({id:i.id,bufferPercent:e});
            return W
        };
        function o() {
        ...
        function v(Y, ac, ab, Z, V) {
            if ((i.skin.getSkinElement("controlbar", Y) !== undefined || Y.indexOf("Text") > 0 || Y.indexOf("divider") === 0) && !(Y.indexOf("divider") === 0 && s.indexOf("divider") === 0)) {
                s = Y;
                var X = {height:i.skin.getSkinElement("controlbar", "background").height,position:"absolute",display:"block",top:0};
        ...
        function R() {
            D({id:i.id,duration:i.jwGetDuration(),position:0});
            r({id:i.id,bufferProgress:0});
            T({id:i.id,mute:i.jwGetMute()});
            p({id:i.id,newstate:a.api.events.state.IDLE});
            k({id:i.id,volume:i.jwGetVolume()})
        }
        ...
        function M(V) {
            ...
            var W = J[V + "Slider"];
            _css(J.elements, {cursor:"pointer"});
            _css(W, {cursor:"pointer"});
        ...
        function r(W) {
            ...
            _css(J.timeSliderBuffer, {width:V})
        }
        ...
        function F(V) {
            D(a.utils.extend(V, {position:0,duration:Q}))
        }
        ...
        function u() {
            ...
            _css(J.timeSliderRail, {width:(V.width - O - B),left:X});
            if (J.timeSliderCapRight !== undefined) {
                _css(J.timeSliderCapRight, {left:X + (V.width - O - B)})
            }
            _css(P, W);
            _css(J.elements, V);
            o();
        ...
        function k(Z) {
            if (J.volumeSliderRail !== undefined) {
                ...
                _css(J.volumeSliderProgress, {width:V,left:W});
                if (J.volumeSliderCapLeft !== undefined) {
                    _css(J.volumeSliderCapLeft, {left:0})
                }
            }
        }
...
(function(b) {
    ...
    b.html5.controller = function(s, q, d, p) {
        ...
        function A() {
            try {
                if (x.playlist[0].levels[0].file.length > 0) {
                    switch (x.state) {case b.api.events.state.PLAYING:case b.api.events.state.BUFFERING:x.getMedia().pause();break
                    }
                }
                return true
            } catch(C) {
        ...
        function w(C) {
            try {
                if (x.playlist[0].levels[0].file.length > 0) {
                    switch (x.state) {case b.api.events.state.PLAYING:case b.api.events.state.PAUSED:case b.api.events.state.BUFFERING:x.getMedia().seek(C);break
                    }
                }
                return true
            } catch(D) {
        ...
        function n(D) {
            ...
            try {
                if (x.playlist[0].levels[0].file.length > 0) {
                    ...
                    x.item = D;
                    z = true;
                    h.sendEvent(b.api.events.JWPLAYER_PLAYLIST_ITEM, {item:D});
        ...
        function y(D) {
            try {
                switch (typeof(D)) {case"number":x.getMedia().volume(D);break;case"string":x.getMedia().volume(parseInt(D, 10));break
                }
                return true
            } catch(C) {
                h.sendEvent(b.api.events.JWPLAYER_ERROR, C)
        ...
        function m() {
            x.resetEventListeners();
            x.addGlobalListener(l);
            switch (x.config.repeat.toUpperCase()) {case b.html5.controller.repeatoptions.SINGLE:o();break;case b.html5.controller.repeatoptions.ALWAYS:if (x.item == x.playlist.length - 1 && !x.config.shuffle) {
                n(0);
                o()
            } else {
                f()
            }break;case b.html5.controller.repeatoptions.LIST:if (x.item == x.playlist.length - 1 && !x.config.shuffle) {
                n(0)
            } else {
                f()
            }break
...
(function(a) {
    ...
    a.html5.display = function(k, s) {
        ...
        this.resize = function(w, v) {
            f = w;
            t = v;
            _css(d.display, {width:w,height:v});
            _css(d.display_text, {width:(w - 10),top:((t - d.display_text.getBoundingClientRect().height) / 2)});
            _css(d.display_image, {width:w,height:v});
            _css(d.display_iconBackground, {top:((t - q.skin.getSkinElement("display", "background").height) / 2),left:((f - q.skin.getSkinElement("display", "background").width) / 2)});
            i({})
        };
        function n(v, x) {
        ...
        function i(v) {
            ...
            switch (q.jwGetState()) {case a.api.events.state.BUFFERING:h("bufferIcon");r = 0;l = setInterval(function() {
                r += j;
                a.html5.utils.animations.rotate(d.display_icon, r % 360)
            }, e);h("bufferIcon");break;case a.api.events.state.PAUSED:_css(d.display_image, {background:"transparent no-repeat center center"});h("playIcon");break;case a.api.events.state.IDLE:if (q.jwGetPlaylist()[q.jwGetItem()].image) {
                _css(d.display_image, {display:"block"});
                d.display_image.src = a.html5.utils.getAbsolutePath(q.jwGetPlaylist()[q.jwGetItem()].image)
            } else {
                _css(d.display_image, {display:"none"});
                delete d.display_image.src
            }h("playIcon");break;default:if (q.jwGetMute()) {
                _css(d.display_image, {display:"none"});
                delete d.display_image.src;
                h("muteIcon")
            } else {
...
(function(jwplayer) {
    jwplayer.html5.eventdispatcher = function(id, debug) {
        ...
        this.sendEvent = function(type, data) {
            ...
            jwplayer.utils.extend(data, {id:_id,version:jwplayer.html5.version,type:type});
            if (_debug) {
...
(function(a) {
    a.html5.extensionmap = {"3gp":"video/3gpp","3gpp":"video/3gpp","3g2":"video/3gpp2","3gpp2":"video/3gpp2",flv:"video/x-flv",f4a:"audio/mp4",f4b:"audio/mp4",f4p:"video/mp4",f4v:"video/mp4",mov:"video/quicktime",m4a:"audio/mp4",m4b:"audio/mp4",m4p:"audio/mp4",m4v:"video/mp4",mkv:"video/x-matroska",mp4:"video/mp4",sdp:"application/sdp",vp6:"video/x-vp6",aac:"audio/aac",mp3:"audio/mp3",ogg:"audio/ogg",ogv:"video/ogg",webm:"video/webm"}
})(jwplayer);
(function(a) {
    var b = {prefix:"http://l.longtailvideo.com/html5/",file:"logo.png",link:"http://www.longtailvideo.com/players/jw-flv-player/",margin:8,out:0.5,over:1,timeout:3,hide:true,position:"bottom-left"};
    _css = a.html5.utils.css;
    a.html5.logo = function(g, h) {
        ...
        c.onclick = e;
        function k() {
            var p = {textDecoration:"none",position:"absolute"};
        ...
        function m(n) {
            switch (l.jwGetState()) {case a.api.events.state.BUFFERING:c.style.display = "block";c.style.opacity = f.out;if (f.hide) {
                d()
            }break;case a.api.events.state.PAUSED:break;case a.api.events.state.IDLE:break;case a.api.events.state.PLAYING:break;default:if (f.hide) {
                d()
            }break
            }
        }
    ...
    a.html5.mediavideo = function(f, C) {
        ...
        function s(N) {
            ...
            if (d != N) {
                ...
                H.sendEvent(a.api.events.JWPLAYER_PLAYER_STATE, {oldstate:O,newstate:N});
                if (P) {
        ...
        function q(N) {
            var O = {height:N.target.videoHeight,width:N.target.videoWidth,duration:Math.round(N.target.duration * 10) / 10};
            ...
            H.sendEvent(a.api.events.JWPLAYER_MEDIA_META, {metadata:O})
        }
        ...
        function J(O) {
            ...
            if (O !== undefined && O.target !== undefined) {
                ...
                if (d == a.api.events.state.PLAYING) {
                    ...
                    H.sendEvent(a.api.events.JWPLAYER_MEDIA_TIME, {position:Math.round(O.target.currentTime * 10) / 10,duration:Math.round(O.target.duration * 10) / 10})
                }
            }
            z(O)
        }
        ...
        function E() {
            ...
            M = setTimeout(function() {
                if (!F) {
                    z({lengthComputable:true,loaded:1,total:1})
                }
            }, N * 10)
        }
        ...
        function z(P) {
            ...
            if (!F) {
                ...
                if (O !== null && (O > h.buffer)) {
                    ...
                    H.sendEvent(a.api.events.JWPLAYER_MEDIA_BUFFER, {bufferPercent:Math.round(O)})
                }
            }
        }
        ...
        function l(P) {
            ...
            if ((P.target.error && P.target.tagName.toLowerCase() == "video") || P.target.parentNode.error && P.target.parentNode.tagName.toLowerCase() == "video") {
                ...
                switch (N.code) {case N.MEDIA_ERR_ABORTED:O = "You aborted the video playback: ";break;case N.MEDIA_ERR_NETWORK:O = "A network error caused the video download to fail part-way: ";break;case N.MEDIA_ERR_DECODE:O = "The video playback was aborted due to a corruption problem or because the video used features your browser did not support: ";break;case N.MEDIA_ERR_SRC_NOT_SUPPORTED:O = "The video could not be loaded, either because the server or network failed or because the format is not supported: ";break;default:O = "An unknown error occurred: ";break
                }
            } else {
            ...
            O += j();
            B = true;
            H.sendEvent(a.api.events.JWPLAYER_ERROR, {error:O});
            return
        }
        ...
        this.volume = function(N) {
            x.volume = N / 100;
            h.volume = N;
            H.sendEvent(a.api.events.JWPLAYER_MEDIA_VOLUME, {volume:Math.round(N)})
        };
        this.mute = function(N) {
            x.muted = N;
            h.mute = N;
            H.sendEvent(a.api.events.JWPLAYER_MEDIA_MUTE, {mute:N})
        };
        this.resize = function(O, N) {
            if (false) {
                b(x, {width:O,height:N})
            }
            H.sendEvent(a.api.events.JWPLAYER_MEDIA_RESIZE, {fullscreen:h.fullscreen,width:O,hieght:N})
        };
        ...
        function I(U) {
            ...
            if (K === 0) {
                B = true;
                H.sendEvent(a.api.events.JWPLAYER_ERROR, {error:"The video could not be loaded because the format is not supported by your browser: " + j()})
            }
            if (h.config.chromeless) {
        ...
        function k(R) {
            ...
            var U = {movie:R,allowFullScreen:"true",allowscriptaccess:"always"};
            for (var N in U) {
            ...
            var P = {src:R,type:"application/x-shockwave-flash",allowscriptaccess:"always",allowfullscreen:"true",width:document.getElementById(f.id).style.width,height:document.getElementById(f.id).style.height};
            for (var Q in P) {
                T[Q] = P[Q]
            }
            O.appendChild(T);
...
(function(jwplayer) {
    ...
    jwplayer.html5.model = function(api, container, options) {
        ...
        _model.plugins = {order:pluginorder,config:{controlbar:{position:jwplayer.html5.view.positions.BOTTOM}},object:{}};
        ...
        _model.loadPlaylist = function(arg, ready) {
            ...
            if (!ready) {
                ...
                _eventDispatcher.sendEvent(jwplayer.api.events.JWPLAYER_PLAYLIST_ITEM, {item:_model.item})
            }
...
(function(a) {
    a.html5.playlistitem = function(c) {
        var b = {author:"",date:"",description:"",image:"",link:"",mediaid:"",tags:"",title:"",provider:"",file:"",streamer:"",duration:-1,start:0,currentLevel:-1,levels:[]};
        for (var d in b) {
            if (c[d] !== undefined) {
                b[d] = c[d]
            }
    ...
    a.html5.skinloader = function(f, n, i) {
        ...
        function d(w) {
            ...
            for (var F = 0; F < C.length; F++) {
                ...
                var z = {settings:{},elements:{},layout:{}};
                m[A] = z;
                ...
                if (J !== undefined && J.childNodes.length > 0) {
                    ...
                    for (var u = 0; u < K.length; u++) {
                        var y = K[u];
                        m[A].layout[y.getAttribute("position")] = {elements:[]};
                        ...
                        for (var t = 0; t < L.length; t++) {
                            var r = L[t];
                            m[A].layout[y.getAttribute("position")].elements.push({type:r.tagName});
        ...
        function b(w, v) {
            ...
            m[v].elements[r] = {height:0,width:0,src:"",ready:false};
            u.onload = function(z) {
                g(u, r, v)
            };
    ...
    a.html5.api = function(b, j) {
        ...
        function c(m, l, k) {
            return function() {
                ...
                var n = {id:i.id,version:i.version};
                ...
                m.sendEvent(a.api.events.JWPLAYER_PLAYLIST_ITEM, {item:m.config.item});
